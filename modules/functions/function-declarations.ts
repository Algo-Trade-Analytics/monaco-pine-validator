...
import type { FunctionDeclarationNode, ParameterNode, TypeReferenceNode } from '../../core/ast/nodes';
...
export class FunctionDeclarationsValidator implements ValidationModule {
  ...
  validate(context: ValidationContext, config: ValidatorConfig): ValidationResult {
    ...
    if (astContext?.ast) {
      this.collectFunctionsFromAst(astContext);
      this.collectStaticFunctionDeclarations(context.cleanLines);
    } else {
      // Collect and validate function declarations via legacy scanning
  ...
  private collectFunctionsFromAst(context: AstValidationContext): void {
