...
export const annotations: Record<string, PineAnnotationMetadata> = {
  "@description": {
    "name": "@description",
  ...
  "@version=": {
    ...
    "example": "//This indicator has no version annotation, so it will try to use v1.//Pine Script® v1 has no function named `indicator()`, so the script will not compile.indicator(\"Pine v1 Indicator\")plot(close)",
