...
*/
import { DRAW_TABLE_EXTRA_CONSTANTS, STRATEGY_RISK_EXTRA_CONSTANTS, STRATEGY_COMMISSION_EXTRA_CONSTANTS, PLOT_STYLE_CONSTANTS, LINE_STYLE_CONSTANTS, LABEL_STYLE_CONSTANTS, HLINE_STYLE_CONSTANTS, ORDER_CONSTANTS, POSITION_CONSTANTS } from '../core/constants-registry';
...
const ALL_SPECIALIZED_CONSTANTS = new Set(SPECIALIZED_CONSTANT_SETS.flatMap((set) => Array.from(set)));
export class FinalConstantsValidator {
    constructor() {
        this.name = 'FinalConstantsValidator';
        this.priority = 65; // Lower priority - these are the final edge cases
        this.errors = [];
        this.warnings = [];
        this.info = [];
        // Usage tracking for all final constants
        this.mathConstantUsage = new Map();
        this.styleConstantUsage = new Map();
        this.orderConstantUsage = new Map();
        this.positionConstantUsage = new Map();
        this.specializedConstantUsage = new Map();
    }
    getDependencies() {
