...
export class EnhancedMigrationValidator {
    constructor() {
        this.name = 'EnhancedMigrationValidator';
    ...
    validateAstCallExpression(call) {
    ...
    validateAstTaNamespace(call, functionName) {
        const namespace = this.getCallNamespace(call.callee);
    ...
    validateAstTranspArgument(args) {
    ...
    validateAstTranspAssignment(node) {
    ...
    validateAstTranspDeclaration(node) {
    ...
    reportSecurityDeprecation(callee) {
        const { line, column } = this.getCallLocation(callee);
    ...
    reportTaNamespaceWarning(callee, functionName) {
        const { line, column } = this.getCallLocation(callee);
    ...
    getRightmostIdentifier(expression) {
