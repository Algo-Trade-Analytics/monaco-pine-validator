import { Enum, For, If, Import, LParen, LBracket, Repeat, Return, Switch, Type, While, Break, Continue, Newline, Indicator, Strategy, Library, Identifier as IdentifierToken, } from '../tokens';
import { isExportKeywordToken, isTokenKeyword } from '../parser-utils';
export function createStatementRule(parser) {
    return parser.createRule('statement', () => {
